...
const ServiceDescription = memo(({ project }: { project: Project }) => {
  ...
  return (
    <>
      <Grid sx={{ mb: 3 }} id={SETUP_SURVEY_SECTION.price_step_description}>
        <Heading5 translation-key="price_test_setup_basic_infor_service_description_title">
          {t('price_test_setup_basic_infor_service_description_title')}
        </Heading5>
        <ParagraphSmall
          sx={{ mb: 1 }}
          $colorName="--eerie-black"
          translation-key="price_test_setup_basic_infor_service_description_subtitle"
        >
          {t('price_test_setup_basic_infor_service_description_subtitle')}
        </ParagraphSmall>
        <Stack className={classes.formWrapper}>
          ...
          <Box className={classes.descriptionForm} sx={{ py: 2 }}>
            <Stack className={classes.introduceSection} sx={{ mb: 2 }}>
              <DesciptionSampleText translation-key="price_test_desciption_service_text_1">
                {t('price_test_desciption_service_text_1')}
              </DesciptionSampleText>
              <DashedInputField
                name="name"
                placeholder={t('price_test_placeholder_service_text_1')}
                translation-key="price_test_placeholder_service_text_1"
                control={control}
                onSave={onSave}
                disabled={!editable}
              />
              <DesciptionSampleText translation-key="price_test_desciption_service_text_2">
                {t('price_test_desciption_service_text_2')}
              </DesciptionSampleText>
              <DashedInputField
                name="brand"
                placeholder={t('price_test_placeholder_service_text_2')}
                translation-key="price_test_placeholder_service_text_2"
                control={control}
                onSave={onSave}
                disabled={!editable}
              />
              <DesciptionSampleText translation-key="price_test_desciption_service_text_3">
                {t('price_test_desciption_service_text_3')}
              </DesciptionSampleText>
              <DashedInputField
                name="provider"
                placeholder={t('price_test_placeholder_service_text_3')}
                translation-key="price_test_placeholder_service_text_3"
                control={control}
                onSave={onSave}
                disabled={!editable}
              />
            ...
            <Stack className={classes.introduceSection} sx={{ mb: 2 }}>
              <DesciptionSampleText
                sx={{ mr: 1 }}
                translation-key="price_test_desciption_service_text_4"
              >
                {t('price_test_desciption_service_text_4')}
              </DesciptionSampleText>
              <DashedInputField
                name="packing"
                placeholder={t('price_test_placeholder_service_text_4')}
                translation-key="price_test_placeholder_service_text_4"
                control={control}
                onSave={onSave}
                disabled={!editable}
              />
