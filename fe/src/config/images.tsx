...
import uploadImageIcon from "assets/img/icon/ic-uploadImage.svg";
import dropFileIcon from "assets/img/icon/ic-dropFile.svg";
import categoryIcon from "assets/img/icon/ic-category.svg";
