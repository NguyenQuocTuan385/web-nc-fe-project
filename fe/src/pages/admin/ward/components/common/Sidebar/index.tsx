...
import { faPeopleRoof, faCircleCheck, faChartSimple, faUserPlus, faUserPen } from "@fortawesome/free-solid-svg-icons";
  ...
  const sideBarItem: SidebarItem[] = [
    {
      ...
      children: [{ name: "Các điểm đặt quảng cáo" }, { name: "Bảng quảng cáo" }, { name: "Báo cáo" }]
    },
    {
      name: "Xét duyệt",
