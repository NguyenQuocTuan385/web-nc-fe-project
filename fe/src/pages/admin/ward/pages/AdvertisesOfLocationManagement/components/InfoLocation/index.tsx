  ...
  return (
    <Box className={classes["info-container"]}>
      <Box className={classes["info-item"]}>
        <img
          src="https://quangcaotb.vn/wp-content/uploads/tam-pano.png"
          alt="Điểm đặt quảng cáo"
        />
        ...
        <Typography className={classes["inline-typo"]}>
          ...
          <span>[{data.latitude}, {data.longtitude}]</span>
        </Typography>
        <Typography variant="h6" style={{ textTransform: "uppercase" }} className={ `${classes['planning-text']} ${data.planning? classes['active']: classes['inactive']}` }>{ data.planning? 'đã quy hoạch': 'chưa quy hoạch' }</Typography>
      </Box>
